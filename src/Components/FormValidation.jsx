...
//                 <div className="card mt-10" style={{border:"none",}} >
//                     <form className="card-body" onSubmit={this.onFormSubmit} style={{backgroundImage:'url(https://static.vecteezy.com/system/resources/thumbnails/001/925/480/small/business-graph-chart-of-stock-market-investment-on-blue-background-vector.jpg)'}}>
...
//                             <button type="submit" className="btn btn-block btn-warning" style={{ color: 'white', width: 300, marginLeft: 300 }}>Send</button>
//                         </div>
//                     </form>
//                 </div>
//             </div>
